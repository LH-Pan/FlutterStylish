  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        ...
        children: [
          MainImageView(contentWidth: contentWidth)
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            ...
            Expanded(
              ...
              const Expanded(
                  flex: 2, child: Text('1', textAlign: TextAlign.center)),
              Expanded(
                  flex: 1,
                  child: InkWell(
                      onTap: () {},
            ...
            Expanded(
              child: TextButton(
                ...
                child: const Text(
                  ...
                  style: TextStyle(color: Colors.white, fontSize: 20)).addPadding(bottom: 12, top: 12))
            )
          ]).addPadding(bottom: 5),
          const Text('實品顏色依照單品照為主',
                  style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16))
              .addPadding(bottom: 5),
          const Text('棉 100%',
                  style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16))
